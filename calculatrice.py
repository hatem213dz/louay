...
btnx = tk.Button(root, text="x", command=lambda: add_to_calculation("*"), width=5, font=("Arial", 14))
btnx.grid(row=4, column=4)

btnd = tk.Button(root, text="/", command=lambda: add_to_calculation("/"), width=5, font=("Arial", 14))
btnd.grid(row=5, column=4)

btnop = tk.Button(root, text="(", command=lambda: add_to_calculation("("), width=5, font=("Arial", 14))
btnop.grid(row=5, column=1)

btncl = tk.Button(root, text=")", command=lambda: add_to_calculation(")"), width=5, font=("Arial", 14))
btncl.grid(row=5, column=3)

btnclear = tk.Button(root, text="C", command= clear_field, width=5, font=("Arial", 14))
btnclear.grid(row=6, column=4)

btnequals = tk.Button(root, text="=", command= evaluate_calculation, width=5, font=("Arial", 14))
btnequals.grid(row=6, column=1,)
